...
def create_pred_featurizer(spect_bin_config, pred_featurizer_config):
    return PredFeaturizer(bin_config=spect_bin_config, **pred_featurizer_config)
...
class MolFeaturizer(torch.utils.data.Dataset):
    ...
    def __call__(self, mol):
        ...
        f_vect = atom_features.feat_tensor_atom(mol, conf_idx=0, **self.feat_vert_args)
        ...
        if self.vert_subset_samples_n > 0:
            ...
            atom_subsets_formula_idx = util.get_subset_peaks_idx_from_formulae_fast(
